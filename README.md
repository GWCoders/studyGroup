...
Check out the [`CONTRIBUTING` file](https://github.com/GWCoders/studyGroup/blob/gh-pages/CONTRIBUTING.md) or [the page on the site](https://gwcoders.github.io/studyGroup/CONTRIBUTING) for more details.
...
The instructions below will help you set up the online tools for your Mozilla Study Group - but if you're looking for organization strategies, event plans and lesson ideas, check out the [Mozilla Study Group Handbook](https://mozillascience.github.io/studyGroupHandbook/)!
